...
namespace BindingModels
{
    ...
    //    }
    //    public string PrintDialogOption { get; set; }
    ...
    //    public Document(string contentType = default(string), string contents = default(string), List<DocTabItem> docTab = default(List<DocTabItem>), string fileFormat = "", List<DocumentPage> pages = default(List<DocumentPage>), string printDialogOption ="", ResolutionEnum? resolution = default(ResolutionEnum?), string size = "", string type = default(string))
    //    {
