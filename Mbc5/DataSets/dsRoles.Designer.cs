...
namespace Mbc5.DataSets {
    ...
    public partial class dsRoles : global::System.Data.DataSet {
        ...
        public partial class rolesDataTable : global::System.Data.TypedTableBase<rolesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public rolesRow AddrolesRow(string id, string name, int rank) {
...
namespace Mbc5.DataSets.dsRolesTableAdapters {
    ...
    public partial class rolesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[roles] WHERE (([id] = @Original_id) AND ([name] = @Original_na" +
                "me) AND ((@IsNull_rank = 1 AND [rank] IS NULL) OR ([rank] = @Original_rank)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[roles] ([id], [name], [rank]) VALUES (@id, @name, @rank);\r\nSEL" +
                "ECT id, name, rank FROM roles WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[roles] SET [id] = @id, [name] = @name, [rank] = @rank WHERE (([id] " +
                "= @Original_id) AND ([name] = @Original_name) AND ((@IsNull_rank = 1 AND [rank] " +
                "IS NULL) OR ([rank] = @Original_rank)));\r\nSELECT id, name, rank FROM roles WHERE" +
                " (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, rank FROM dbo.roles";
        ...
        public virtual int Fill(dsRoles.rolesDataTable dataTable) {
        ...
        public virtual dsRoles.rolesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsRoles.rolesDataTable dataTable = new dsRoles.rolesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsRoles.rolesDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsRoles dataSet) {
        ...
        public virtual int Delete(string Original_id, string Original_name, global::System.Nullable<int> Original_rank) {
            if ((Original_id == null)) {
        ...
        public virtual int Insert(string id, string name, global::System.Nullable<int> rank) {
            if ((id == null)) {
        ...
        public virtual int Update(string id, string name, global::System.Nullable<int> rank, string Original_id, string Original_name, global::System.Nullable<int> Original_rank) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> rank, string Original_id, string Original_name, global::System.Nullable<int> Original_rank) {
            return this.Update(Original_id, name, rank, Original_id, Original_name, Original_rank);
        }
    }
