...
namespace Mbc5.Forms.MixBook
{
    ...
    public partial class frmBarScan : BaseClass.frmBase
    {
        ...
        private void txtBarCode_Leave(object sender, EventArgs e)
        {
            ...
            lblLastScan.Text = txtBarCode.Text + "  " + DateTime.Now.ToString();
            string vInvno = "";
            if (string.IsNullOrEmpty(txtBarCode.Text))
            {
                return;
        ...
        private void SetDepartmentCode(string name)
        {
            ...
            switch (name)
            {
                case "PRESS":
                    ...
                    this.Department.Initials = "PS";
                    this.Department.AutoTime = .1m;
                    break;
                case "TRIMMING":
                    this.Department.DeptCode = "43";
                    this.Department.Initials = "TR";
                    this.Department.AutoTime = .1m;
                    break;
                case "BINDING":
                    this.Department.DeptCode = "39";
                    this.Department.Initials = "BI";
                    this.Department.AutoTime = .1m;
                    break;
                case "BINDING2":
                    this.Department.DeptCode = "39";
        ...
        private void ClearScan()
        {
            ...
            if (ApplicationUser.UserName.ToUpper() == "SHIPPING")
            {
                txtTrackingNumber.Focus();
            }
            else
        ...
        private void txtTrackingNumber_Leave(object sender, EventArgs e)
        {
            txtBarCode.Focus();
        }
