namespace Mbc5.Forms.MemoryBook {
	partial class frmReceivingCard {
		...
		private void InitializeComponent() {
			...
			this.kitReceivedDateDateTimePicker = new Classes.NullableDateTimePicker();
			this.ck1CheckBox = new System.Windows.Forms.CheckBox();
			this.ck2CheckBox = new System.Windows.Forms.CheckBox();
			this.guardteDateTimePicker = new Classes.NullableDateTimePicker();
			this.deadlineDateTimePicker = new Classes.NullableDateTimePicker();
			this.estdateDateTimePicker = new Classes.NullableDateTimePicker();
