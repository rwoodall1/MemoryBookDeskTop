...
namespace Core
{
    public static class ErrorValues
    {
        ...
        public static readonly string UserNameAlreadyExistsUserHelp = "User failed validation. Username, Email already exist in the database.";
        ...
        public static readonly ApiProcessingError TEAM_CRUD_PERMISSIONS_ERROR = new ApiProcessingError("You cannot perform this action on a location.", TeamCrudPermissionsUserHelp, "");
        ...
        public static readonly ApiProcessingError GENERIC_GET_TEAM_IN__ERROR = new ApiProcessingError("Failed to get location in agent.", ContactSupportUserHelp, "");
        ...
        public static readonly ApiProcessingError COULD_NOT_FIND_TEAM_IN__ERROR = new ApiProcessingError("Failed to find location in agent.", "Could not find this location in this agent. If you think this is a mistake, please contact support.", "");
        public static readonly ApiProcessingError COULD_NOT_FIND_TEAMS_IN__ERROR = new ApiProcessingError("Failed to find any locations in agent.", "Could not find any locations in this agent. If you think this is a mistake, please contact support.", "");
        ...
        public static readonly ApiProcessingError GENERIC_UPDATE_TEAM_COMMISSIONS_ERROR = new ApiProcessingError("Failed to update location commissions.", ContactSupportUserHelp, "");
        public static readonly ApiProcessingError UPDATE_TEAM_NOT_IN__ERROR = new ApiProcessingError(TeamUpdateFailedUserMessage, "You are attempting to edit a location that does not belong to your agent.  If you think this is a mistake, please contact support.", "");
        public static readonly ApiProcessingError UPDATE_TEAM_GROUP_NOT_IN_ = new ApiProcessingError(TeamUpdateFailedUserMessage, "You are attempting to assign this location to a group that does not exist within your agent. If you think this is a mistake, please contact support", "");
        ...
        public static readonly ApiProcessingError DELETE_TEAM_WITHOUT_ID_ERROR = new ApiProcessingError(TeamDeleteFailedUserMessage, "Please provide the Id of the location you would like to delete.", "");
        ...
        public static readonly ApiProcessingError TEAM_ASSIGNMENT_VALIDATION_FAILED_ERROR = new ApiProcessingError("Failed to validate location assignment.", ContactSupportUserHelp, "");
